"""
Django settings for Starter App project.
...
DATABASES = {
    'default': {
        ...
        'NAME': env('DJANGO_DATABASE_NAME', default='starter_app'),
...
LANGUAGE_CODE = 'en-us'
LANGUAGE_COOKIE_NAME = 'starter_app_language'
LANGUAGES = [
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Starter App',
    'DESCRIPTION': 'A starter project with a server-rendered SPA architecture.',
    'VERSION': '0.1.0',
...
ADMINS = [('Jared Black', 'jaredblackjcb@gmail.com')]
...
LOGGING = {
    ...
    'loggers': {
        ...
        'starter_app': {
            'handlers': ['console'],
            'level': env('STARTER_APP_LOG_LEVEL', default='INFO'),
        }
    }
}
